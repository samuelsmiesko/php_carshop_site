<?php require_once '../ajax_php/templates/includes/search_view.inc.php'; ?> 
...
<!-- <?php
    ...
    if (mysqli_num_rows($results) > 0) {
        while ($row = mysqli_fetch_assoc($results)) { ?>
                ...
                <?php
                $dir =
                    "../ajax_php/templates/database/article" . $row["id"] . "/"; //;
                ...
                <div class="container text-bg-light mt-3 p-3">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-6">
                            <p>Počet kilometrov: <?php echo $row[
                                "Milage"
                            ]; ?></p>
